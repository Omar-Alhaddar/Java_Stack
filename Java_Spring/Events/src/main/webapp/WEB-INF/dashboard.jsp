					...
					<c:forEach items="${instate}" var="in">
	  				<tr>
                        ...
                        <c:when test="${in.user == user}">
                            <td>Joining | <a href="/events/${in.id}/edit">Edit</a> | <a href="events/${in.id}/delete">Delete</a></td>
                        </c:when>
                        <c:otherwise>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td>Joining | <a href="events/${in.id}/cancel">Cancel</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:otherwise>
                        </c:choose>  
  				...
  				<tr>
					...
					<c:choose>
                        <c:when test="${out.user == user}">
                            <td>Joining | <a href="/events/${out.id}/edit">Edit</a> | <a href="events/${out.id}/delete">Delete</a></td>
                        </c:when>
                        <c:otherwise>
                            <c:set var="joining" value="${false}"/>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td>Joining | <a href="events/${out.id}/cancel">Cancel</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:otherwise>
                    </c:choose>
